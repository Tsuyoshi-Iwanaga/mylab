...
.top
  ...
  div.simulator(style="marginTop: 20px;") 
    ...
    p プラン
    select(v-model="simulators[0].planList[0]" style="marginBottom: 20px;")
      option(value="01") 01
...
export default class Medical extends Vue {
  ...
  getPrice(): void {
    if (this.priceTable["A"]) {
      this.price = this.priceTable["A"][this.simulators[0].planList[0]][
