...
class UserRepository extends DbRepository
{
  public function insert($user_name, $password)
  {
    ...
    $now = new DateTime();
    $sql = "INSERT INTO test_user(user_name, password, created_at) VALUES(:user_name, :password, :created_at)";
  ...
  {
    return sha1($password. 'Afgeoj146');
  }
  ...
  {
    $sql = "SELECT COUNT(id) as count FROM test_user WHERE user_name = :user_name";
  ...
  public function fetchAllFollowingsByUserId($user_id)
  {
    $sql = "
      ...
      LEFT JOIN test_following f ON f.following_id = u.id
