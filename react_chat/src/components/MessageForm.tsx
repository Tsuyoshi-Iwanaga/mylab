...
export class MessageForm extends React.Component<MessageFormProps, MessageFormState> {
    ...
    return (
      <Segment basic textAlign='center'>
        <Form onSubmit={this.handleFormSubmit}>
          <Form.Field>
            <TextArea placeholder='Write your message' value={this.state.body} onChange={this.handleTextAreaChange} />
          </Form.Field>
  ...
  private handleFormSubmit(evnet: React.FormEvent<HTMLFormElement>) {
